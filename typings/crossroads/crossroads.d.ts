...
declare module CrossroadsJs {
    export interface MatchedRoute {
      _matchRegexp: string;
      _optionalParamIds: Array<string>;
      _paramsIds: Array<string>;
      _pattern: string;
      _priority: Number;
      _router: CrossroadsJs.CrossRoadsStatic;
      matched: Signal;
      switched: Signal;
    }
    ...
    type RouteListener = (request: string, data: RouteData) => void;
    export interface Route {
         ...
         */
        add(listener: RouteListener, listenerContext?: any, priority?: Number): SignalBinding;
    }
